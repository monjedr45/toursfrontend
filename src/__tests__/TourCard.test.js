...
describe('Tore card', () => {
    ...
    test('Render tour card correctly', () => {
        render(<MemoryRouter initialEntries={['/']}>
            <TourCard tour={tour} />
        </MemoryRouter>)
        const tourCardElement = screen.getByRole('tourCard')
        expect(tourCardElement).toBeInTheDocument()
        const headingElement = screen.getByText(/the sea explorer/i)
    ...
    test('renders Login button', () => {
        ...
        const DetailsButtonElement = screen.getByRole('DetailsButton')
